...
pub struct DeployNvaGuerrillasFromAvailable {}

impl Default for DeployNvaGuerrillasFromAvailable {
    fn default() -> Self {
        Self::new()
    }
}

impl DeployNvaGuerrillasFromAvailable {
    pub fn new() -> DeployNvaGuerrillasFromAvailable {
        DeployNvaGuerrillasFromAvailable {}
    }
