...
impl Announcer {
    ...
    pub fn instruct_to_move_faction_cylinder_from_eligible_to_operation_only_box(
        &self,
        faction: Factions,
    ) {
        self.print_instruction(format!(
            "Move the cylinder for the {} faction from Eligible to the Operation Only box.",
            faction
        ));
    }
    ...
    pub fn instruct_to_move_faction_cylinder_from_eligible_to_second_limited_operation_box(
        &self,
        faction: Factions,
    ) {
        self.print_instruction(format!(
            "Move the cylinder for the {} faction from Eligible to the Second Limited Operation box.",
            faction
        ));
    }
